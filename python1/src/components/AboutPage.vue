<template>
  <div class="about-page">
    <div class="stars"></div>
    <div class="header">
      <img alt="运动计数器应用标志" src="@/assets/bgmain.png">
      <h1>运动计数器</h1>
    </div>

    <div class="mission">
      <h2>关于我们</h2>
      <p>运动计数器致力于通过创新技术和用户友好的设计，为您提供一种全新的运动体验。</p>
    </div>
    ...
    <div class="features">
      ...
      <ul>
        ...
        <li><strong>运动视频分析：</strong> 通过分析您的运动视频，为您提供更加精准的运动统计。</li>
        <li><strong>实时运动追踪：</strong> 利用先进的 Mediapipe 技术，实时监测您的身体活动。</li>
        <li><strong>直观用户界面：</strong> 通过简单而直观的界面，轻松查看和分析您的运动数据。</li>
    ...
    <div class="team">
      ...
      <div class="members-container">
        <div class="row">
          <div class="member">
            <img alt="zqh" src="@/assets/zqh.jpg">
            <p><strong>张期皓</strong><br>前端开发</p>
          </div>
          <div class="member">
            <img alt="lp" src="@/assets/lp.jpg">
            <p><strong>李鹏</strong><br>前端开发</p>
          </div>
        </div>
        <div class="row">
          <div class="member">
            <img alt="ysx" src="@/assets/ysx.jpg">
            <p><strong>杨善翔</strong><br>后端开发</p>
          </div>
          <div class="member">
            <img alt="hxl" src="@/assets/hxl.jpg">
            <p><strong>洪晓蕾</strong><br>后端开发</p>
          </div>
          <div class="member">
            <img alt="lqy" src="@/assets/lqy.jpg">
            <p><strong>李穹语</strong><br>后端开发</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="faq">
      ...
      <div class="faq-item">
        <h3>一、如何使用运动计数器</h3>
      <p>运动计数器的使用非常简单，让我们一起来了解如何充分利用这个强大的工具：</p>

      <ol>
        <li><strong>打开应用：</strong> 启动运动计数器并授予摄像头权限。</li>
        <li><strong>站在摄像头前：</strong> 让摄像头捕捉您的身体动作，运动计数器将立即开始追踪。</li>
        <li><strong>查看统计信息：</strong> 在直观的仪表板上查看实时的运动统计和分析。</li>
      </ol>
      </div>
      <br>
      <div class="faq-item">
        <h3>二、运动计数器支持哪些功能？</h3>
        <p>我们的运动计数器提供了跳绳计数、俯卧撑计数、引体向上计数等功能</p>
      </div>
      <br>
      <div class="faq-item">
        <h3>三、如何联系我们？</h3>
        <p>如果您遇到任何问题或有任何建议，请发送电子邮件至<a href="mailto:support@motioncounterapp.com">support@motioncounterapp.com</a>。</p>
      </div>
    </div>
    ...
    <!-- <div class="contact">
      <h2>联系我们</h2>
      <p>有任何问题或建议？我们随时为您提供支持！</p>
      <p>Email: <a href="mailto:info@motioncounterapp.com">info@motioncounterapp.com</a></p>
    </div> -->
  </div>
</template>
